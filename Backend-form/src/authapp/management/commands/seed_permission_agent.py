...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        group_name = 'Agent'  # Replace 'Customer' with your actual group name
        ...
        model_permissions = {
            ...
            "Payment":["view"],
            "ScheduleStatus":["view"],
            "SubscriptionScheduleCall":["view","change"],
            "Subscription":["view","change"]
            # Add more model names and their corresponding permissions as needed
        }
